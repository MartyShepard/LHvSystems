...
Module vWindows
    ...
    ;  Drag and Drop Support
    ;__________________________________________________________________________________________________________________________________________     
    Procedure DragnDrop_Support64_(DropGadget.i,GadgetID.i,DestGadgetID.i)    
        Select EventDropType()
            Case #PB_Drop_Files      
   ...
   ;******************************************************************************************************************************************
    ;
    ; Offnet ein Fnster für die Screenshots
    ;__________________________________________________________________________________________________________________________________________        
    ...
    Procedure OpenWindow_Sys64(GadgetID.i,DestGadgetID.i)                        
        ...
        Repeat
            ...
            Select ListEvent                      
                ...
                Case #PB_Event_GadgetDrop                               
                   DragnDrop_Support64_(ListEventGadget.i,GadgetID.i,DestGadgetID.i)     
