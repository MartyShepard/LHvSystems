...
DeclareModule DC		
	...
	Debug #LFCR$ + "Purebasic Constants Enumeration [DC::]"
	...
	Enumeration 01 Step 1
		...
		#_Window_003
		#_Window_004
		#_Window_005	; C64er Datei Manager
		#_Window_006
		#_Window_007	; Archiv Datei Manager
	EndEnumeration
	...
	;
	;	
	; Reserved Classes:  ImageGadget (TRAY ICON)
	MaxPBEnums.i = 140
	...
	;
	;	
	; Reserved Classes:   Frame Gadget (#ScreenShot, #_PNG_NOxx)
	MaxPBEnums.i = 2160  
	...
	;
	;	
	; Reserved Classes:    Screenshots ImagesID (#_PNG_xxxx)
	MaxPBEnums.i = 2600  	
