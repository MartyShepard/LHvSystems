...
;//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Procedure.s DataVersionFix(Value$)
        ...
        Select Val(Get_WindowsVersion())
            ...
            Case 62 To 99
                Debug "Windows 8/ Windows 10"
                ProcedureReturn "~ "+Value$
            Default
                Debug "OS: '"+Get_WindowsVersion(4)+"' Wird nicht unterstützt"
                ;RequestEX::MSG("Now Look What You've Done","ERROR: Windows Version",#CRLF$+#CRLF$+"LH.Game(Start.i) doesn't Support the OS: '"+Get_WindowsVersion(4)+"'",4,0,"",2,"",0)
                End        
        EndSelect
